...
import { MapPin, Clock, Filter, Search, X } from "lucide-react";
...
const allOpportunities = [
  { id: 1, title: "Community Food Drive", location: "Downtown Center", duration: "4 hours", cause: "Hunger Relief", type: "In-person", skill: "General", image: foodImg, desc: "Help collect and distribute food packages to families in need across the downtown area." },
  { id: 2, title: "Youth Education Program", location: "Lincoln School", duration: "3 hours/week", cause: "Education", type: "In-person", skill: "Teaching", image: eduImg, desc: "Tutor and mentor young students in reading, math, and life skills." },
  { id: 3, title: "Park Restoration Project", location: "Greenfield Park", duration: "Full day", cause: "Environment", type: "In-person", skill: "General", image: envImg, desc: "Help restore the local park by planting trees and cleaning up the area." },
  { id: 4, title: "Housing Build Weekend", location: "Eastside District", duration: "2 days", cause: "Housing", type: "In-person", skill: "Construction", image: housingImg, desc: "Build safe and affordable housing for families who need it most." },
  { id: 5, title: "Online Tutoring", location: "Remote", duration: "2 hours/week", cause: "Education", type: "Online", skill: "Teaching", image: eduImg, desc: "Provide virtual tutoring sessions to students from underserved communities." },
  { id: 6, title: "Meal Preparation", location: "Community Kitchen", duration: "5 hours", cause: "Hunger Relief", type: "In-person", skill: "Cooking", image: foodImg, desc: "Cook and prepare nutritious meals for community distribution events." },
  { id: 7, title: "Tree Planting Initiative", location: "City Parks", duration: "Half day", cause: "Environment", type: "In-person", skill: "General", image: envImg, desc: "Join our city-wide tree planting initiative to create greener urban spaces." },
  { id: 8, title: "Home Repair Assistance", location: "Various Locations", duration: "Flexible", cause: "Housing", type: "In-person", skill: "Construction", image: housingImg, desc: "Help elderly homeowners with essential home repairs and maintenance." },
];
        ...
        <div className="container text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="mx-auto mt-4 max-w-lg text-lg text-primary-foreground/80">
              Find the perfect way to make a difference. Filter by cause, type, or search for specific opportunities.
            </p>
          </motion.div>
        </div>
      </section>
